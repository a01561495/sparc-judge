# 1 "../Proyectoa4550.X/Mensajes50.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../Proyectoa4550.X/Mensajes50.c" 2
...
# 8 "../Proyectoa4550.X/Mensajes50.c" 2
...
# 9 "../Proyectoa4550.X/Mensajes50.c" 2
...
# 10 "../Proyectoa4550.X/Mensajes50.c" 2


# 1 "../Proyectoa4550.X/UART50.h" 1
...
# 12 "../Proyectoa4550.X/Mensajes50.c" 2

# 1 "../Proyectoa4550.X/Mensajes50.h" 1
...
void Tardanza(void);
# 13 "../Proyectoa4550.X/Mensajes50.c" 2

# 1 "../Proyectoa4550.X/EEPROM.h" 1



uint8_t EEPROM_R(uint8_t dir);
void EEPROM_W(uint8_t dir, uint8_t dato);
# 14 "../Proyectoa4550.X/Mensajes50.c" 2

# 1 "../Proyectoa4550.X/SETPOINTS.h" 1
...
# 15 "../Proyectoa4550.X/Mensajes50.c" 2

# 1 "../Proyectoa4550.X/DEFINES_4550_4MHZ.h" 1
...
# 1 "../Proyectoa4550.X/BITSCONF50.h" 1
# 7 "../Proyectoa4550.X/DEFINES_4550_4MHZ.h" 2


# 1 "../Proyectoa4550.X/GPIO.h" 1
...
# 9 "../Proyectoa4550.X/DEFINES_4550_4MHZ.h" 2

# 1 "../Proyectoa4550.X/interrupcciones.h" 1
...
void PARO2aden(void);
void PARO2out(void);
# 10 "../Proyectoa4550.X/DEFINES_4550_4MHZ.h" 2


# 1 "../Proyectoa4550.X/MOTOR.h" 1
...
uint8_t banderaaccion;
# 12 "../Proyectoa4550.X/DEFINES_4550_4MHZ.h" 2

# 1 "../Librerias.X\\PWM4550.h" 1
...
# 13 "../Proyectoa4550.X/DEFINES_4550_4MHZ.h" 2
# 16 "../Proyectoa4550.X/Mensajes50.c" 2
...
uint16_t Obt(uint8_t imp) {
    ...
    if(Xvalor[0]==((void*)0)||Xvalor[1]==((void*)0)||Xvalor[2]==((void*)0)) {
        valor=30000;
    }
    return valor;

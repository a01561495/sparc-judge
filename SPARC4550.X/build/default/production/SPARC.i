...
void __attribute__((picinterrupt(("")))) INT_isr(void) {
    ...
    if(INTCON3bits.INT1IF==1&&PORTBbits.RB1==1) {
        interrupcionX();
        motoresmov(5,0);
        *PX=0;
        *PXN=0;
        INTCON3bits.INT1IF=0;
    } else if(INTCONbits.INT0IF==1&&PORTBbits.RB0==1) {
        interrupcionY();
        motoresmov(0,5);
        *PY=0;
        *PYN=0;
    ...
    }else if(INTCON3bits.INT2IF==1&&PORTBbits.RB2==1) {
        PARO2aden();
...
void main(void) {
    ...
    Acci=UARTRead();
    Acci=0;
    XvalorR=ExtraerDato(252);
    YvalorR=ExtraerDato(254);
    if(PORTBbits.RB1==0) {
        motoresmov(-1000, 0);
    } else {
        motoresmov(5, 0);
    ...
    while(1) {
        ...
        Xvalorn=0;
        Yvalorn=0;
        GuardarsetX(252, XvalorR);
        GuardarsetY(254, YvalorR);
    }
    return;
}
